	...
	{#if showNewTripForm}
		<div class="bg-white rounded-lg shadow-md p-6 mb-8">
			...
			<form onsubmit={createTrip}>
				...
				<div class="mb-4">
					<label for="cover" class="block text-sm font-medium text-gray-700 mb-1">Cover Image <span class="text-gray-400 font-normal">(optional)</span></label>
					<input
						type="file"
						id="cover"
						accept="image/*"
